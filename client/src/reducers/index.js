...
function rootReducer(state = initialState, action) {
  switch (action.type) {
    case GET_DOGS:
      return {
        ...state, // hago copia de estado
        dogs: action.payload, // json que trae todos los perros
        backupDogs: action.payload, // trae todos los perros
      };
    case ADD_DOG:
      return {
        ...state, // hago copia del estado
      };
    case CLEAN_Q:
      return {
        ...state, // hago copia del estado
        detail: [], // // me traigo detalle de los perros
      };
    case FILTER_TEMPERAMENT:
      let allDogs = state.backupDogs; //accedo a todos los perros del state.
